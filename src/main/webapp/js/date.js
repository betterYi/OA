  ...
  with (document) {
	...
	write("</tr>");
  	...
  	for (w = 1; w < 7; w++) {
		write("<tr>");
		for (d = 0; d < 7; d++) {
			write("<td id=calCell "+styleTD+"cursor:hand;' style='padding-left:8;padding-right:8;padding-top:5;padding-bottom:5' onMouseOver='this.bgColor=gcToggle;this.borderColor=gcToggleBorder' onMouseOut='this.bgColor=gcBG;this.borderColor=gcBG' onclick='fSetSelected(this)'>");
