    ...
    <tr>
        <td align="center" valign="top" class="td03"><br>
            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="25" class="F01"><p><img src="../images/index_35.gif" width="12" height="16" align="absmiddle"><strong>**移动OA系统</strong></p>
                    </td>
                </tr>
                <tr>
                                    ...
                                    <div id="menu_4" style="DISPLAY: none">
                                        ...
                                        <div id="menu_5" style="DISPLAY: none">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td nowrap><a href="${pageContext.request.contextPath}/desktop/news/queryNewsLabel.do" target="mainFrame" class="a03">栏目管理</a></td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
                                                    <td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
                                                    <td nowrap><a href="${pageContext.request.contextPath}/desktop/news/newsPublishPre.do" target="mainFrame" class="a03">新闻发布</a></td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
                                                    <td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
                                                    <td nowrap><a href="${pageContext.request.contextPath}/desktop/news/newsMaintenancePre.do" target="mainFrame" class="a03">新闻维护</a></td>
                                                </tr>
                                            </table>
                                        </div>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
                                                <td width="19"><img src="../images/tree_08.gif" width="19" height="20"></td>
                                                <td nowrap><a href="calendar/日程安排.htm" target="mainFrame" class="a03">日程管理</a></td>
                                            </tr>
                                        </table>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
